...
**Capture d’écran :**  
![Ajouter rôles](/admin-homelab/assets/capture/adds/02_add_roles.png)
...
**Capture d’écran :**  
![Assistant rôles](/admin-homelab/assets/capture/adds/03_wizard_navigation.png)
...
**Capture d’écran :**  
![Sélection AD DS](/admin-homelab/assets/capture/adds/04_select_adds.png)
...
**Capture d’écran :**  
![Installation AD DS](/admin-homelab/assets/capture/adds/05_install_adds.png)
...
**Capture d’écran :**  
![Fin installation](/admin-homelab/assets/capture/adds/06_install_complete.png)
