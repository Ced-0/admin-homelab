...
**Capture d’écran :**  
![Gestionnaire de serveur](./captures/01_server_manager.png)
...
**Capture d’écran :**  
![Ajouter rôles](./captures/02_add_roles.png)
...
**Capture d’écran :**  
![Assistant rôles](./captures/03_wizard_navigation.png)
...
**Capture d’écran :**  
![Sélection AD DS](./captures/04_select_adds.png)
...
**Capture d’écran :**  
![Installation AD DS](./captures/05_install_adds.png)
...
**Capture d’écran :**  
![Fin installation](./captures/06_install_complete.png)
